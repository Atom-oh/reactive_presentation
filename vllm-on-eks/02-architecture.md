...
<div style="display:grid;grid-template-columns:1fr auto 1fr;gap:16px;align-items:start;height:440px;">
  ...
  <div style="background:#0d1a1a;border:1px solid #06d6a0;border-radius:12px;padding:16px;">
    ...
    <div style="display:flex;flex-direction:column;gap:8px;">
      ...
      <div data-fragment-index="5" style="background:#162828;border-radius:6px;padding:8px;font-size:12px;">
        <span style="color:#ff9900;font-weight:700;">EKS Pod Identity / IRSA</span> <span style="color:#bbb;">— Pod 레벨 권한</span>
      </div>
      <div data-fragment-index="5" style="background:#162828;border-radius:6px;padding:8px;font-size:12px;">
...
EKS Pod Identity(권장, 2023+) 또는 IRSA(IAM Roles for Service Accounts)를 통해 Pod 레벨에서 IAM 역할을 부여합니다. 노드 전체가 아닌 특정 Pod에만 S3/ECR/Secrets Manager 접근 권한을 부여합니다. EKS Pod Identity는 IRSA보다 설정이 간단하며 신규 클러스터에서는 Pod Identity를 권장합니다.
{cue: transition}
