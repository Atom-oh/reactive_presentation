...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
  <div class="fragment fade-up" data-fragment-index="1" style="background:rgba(239,68,68,0.1);border:1px solid rgba(239,68,68,0.3);border-radius:12px;padding:24px;">
    <div style="font-size:1.6rem;margin-bottom:10px;">😤</div>
    <div style="color:#ef4444;font-weight:bold;font-size:1.25rem;margin-bottom:12px;">반복되는 고통</div>
    <div style="color:#8b95a5;font-size:1.0rem;line-height:1.7;">
  ...
  <div class="fragment fade-up" data-fragment-index="2" style="background:rgba(0,255,136,0.1);border:1px solid rgba(0,255,136,0.3);border-radius:12px;padding:24px;">
    <div style="font-size:1.6rem;margin-bottom:10px;">💡</div>
    <div style="color:#00ff88;font-weight:bold;font-size:1.25rem;margin-bottom:12px;">플러그인으로 해결</div>
    <div style="color:#8b95a5;font-size:1.0rem;line-height:1.7;">
